...
`
  ...
  const BlogContent = () => (
    <section className={styles.pageContent}>
      ...
      <BlogCard image={<First />} title="INTEL NEW 8 CORE CPU" text1={firstText} text2='AUTHOR: Ivan Vilić'/>
      <BlogCard image={<Second />} title="NVIDIA GFORCE RTX3080" text1={secondText} text2='AUTHOR: Ivan Vilić'/>
      <BlogCard image={<Third />} title="AMD RADEON RX5700" text1={thirdText} text2='AUTHOR: Mateo Sikirica'/>
      <BlogCard image={<Fourth />} title="AMD 3 RYZEN 5000 PROCESSOR" text1={fourthText} text2='AUTHOR: Mateo Sikirica'/>
    </section>
    )
